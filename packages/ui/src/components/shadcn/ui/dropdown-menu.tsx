...
import { getPrototypeProductOverlayPortalContainer } from '../../../lib/prototype-overlay-portal'
...
>(({ className, ...props }, ref) => (
  <DropdownMenuPrimitive.Portal container={getPrototypeProductOverlayPortalContainer()}>
