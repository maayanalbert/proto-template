---
name: styles-design
description: Design system skill for styles. Activate when building UI components, pages, or any visual elements. Provides exact color tokens, typography scale, spacing grid, component patterns, and craft rules. Read references/DESIGN.md before writing any CSS or JSX.
---

# styles Design System

You are building UI for **styles**. Light-themed, neutral palette, sans-serif typography (sans-serif), compact density on a 4px grid, flat elevation (no shadows).
...
| Variable | Light | Dark |
|----------|-------|------|
| `--background` | `var(--color-white)` | `color-mix(` |
...
| `--popover` | `var(--color-white)` | `color-mix(in srgb, var(--background) 96%, var(--color-white))` |
...
| `--destructive` | `var(--color-red-500)` | `color-mix(` |
...
- Creating new components, pages, or visual elements for styles
- Writing CSS, Tailwind classes, styled-components, or inline styles
- Building page layouts, templates, or responsive designs
- Reviewing UI code for design consistency
- The user mentions "styles" design, style, UI, or theme
